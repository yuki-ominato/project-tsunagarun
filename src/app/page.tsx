...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-start bg-gradient-to-br from-emerald-100 via-teal-100 to-green-200 p-0">
      {/* ヒーローセクション */}
      <section className="w-full flex flex-col items-center justify-center pt-20 pb-10">
        <div className="flex flex-col items-center gap-4">
          ...
          <h1 className="text-5xl font-extrabold text-teal-700 drop-shadow-lg tracking-tight">つながるん</h1>
          <p className="text-lg text-gray-700 font-medium text-center max-w-xl">
            <Sparkles className="inline-block mr-2 text-teal-400 animate-pulse" />
            新しいつながり、ここから始まる。<br />
